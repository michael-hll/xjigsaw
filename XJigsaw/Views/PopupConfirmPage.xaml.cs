...
{
    public partial class PopupConfirmPage : Rg.Plugins.Popup.Pages.PopupPage
    {
        IConfirm confirm = null;
        public PopupConfirmPage(string title, string message)
        {
        ...
        async void CloseButton_Clicked(System.Object sender, System.EventArgs e)
        {
            ...
            try
            {
                //await Device.InvokeOnMainThreadAsync(() => confirm.IsConfirm = false);
